...
import { TrendingUp, CheckCircle2, ArrowDown, ArrowUp, Sparkles } from 'lucide-react';
...
const fallbackMetrics = [
  { id: 1, label: 'CPA (Cost per Acquisition)', value: '-40%', icon: ArrowDown, color: '#00C853', bgColor: '#E8F5E9', description: 'Reduced from $15.00 to $9.00' },
  { id: 2, label: 'Conversion Rate', value: '+2.5x', icon: ArrowUp, color: '#00C853', bgColor: '#E8F5E9', description: 'Improved from 1.2% to 3.0%' },
  { id: 3, label: 'ROAS', value: '+164%', icon: ArrowUp, color: '#00C853', bgColor: '#E8F5E9', description: 'Increased from 2.2x to 5.8x' },
  { id: 4, label: 'CTR (Click-through Rate)', value: '+180%', icon: ArrowUp, color: '#00C853', bgColor: '#E8F5E9', description: 'Improved from 0.8% to 2.24%' },
];

const fallbackInsights = [
  { id: 1, title: 'TikTok Outperformance', description: 'Skincare Geeks ads on TikTok achieved 95% above expected CPA targets', impact: 'High' },
  { id: 2, title: 'Instagram Engagement', description: 'City Commuter creatives saw 3.2x higher engagement on Instagram Stories', impact: 'High' },
  { id: 3, title: 'Budget Optimization', description: 'AI reallocated 35% more budget to high-performing segments automatically', impact: 'Medium' },
];
      ...
      <div className="bg-white rounded-lg border border-[rgba(0,0,0,0.08)] p-6 shadow-sm">
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="text-sm text-[#6B7280]">Return on Ad Spend - 6 Week Period</p>
          </div>
