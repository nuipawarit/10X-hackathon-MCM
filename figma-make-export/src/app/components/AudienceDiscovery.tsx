import { Users, FlaskConical, Building2, ArrowRight, Sparkles, Target } from "lucide-react";
...
export function AudienceDiscovery() {
            ...
            <div className="p-6 border-b border-[rgba(0,0,0,0.08)]">
              <div className="flex items-start gap-4">
                <div
                  ...
                  style={{ backgroundColor: persona.iconBg }}
                >
                  <persona.icon className="w-8 h-8" style={{ color: persona.iconColor }} />
                </div>
              ...
              <div>
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between text-sm">
                    ...
                    <span className="font-semibold text-[#00C853]">{persona.intent}%</span>
                  </div>
